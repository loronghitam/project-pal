                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control" id="email-edit" placeholder="John Doe"
                               aria-describedby="floatingInputHelp" name="email" readonly/>
                        <label for="title-edit">Email</label>
                    </div>

                    <div class="form-floating mt-3">
                        <input type="text" class="form-control" id="phone-edit" placeholder="John Doe"
                    ...
                    <div class="form-check form-switch mt-3">
                        <input class="form-check-input" type="checkbox" id="checkbox"
                               name="prioritas"/>
                        <label class="form-check-label" for="checkbox" id="checklabel">Validasi
                            Pembayaran</label>
                    </div>
